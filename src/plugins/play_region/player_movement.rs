use crate::{
    modules::game_events::TriggerEvent, region::region_map::geometry::GEOMETRY_SIZE,
    state::WanderResource,
};
use bevy::prelude::*;
use serde::{Deserialize, Serialize};

use super::{WanderCamera, WanderLight, WanderingPlayer};
